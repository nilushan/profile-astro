...
description: "A learning system for small-business enquiries: LangGraph routes the job, code calculates the quote, PostgreSQL holds state, and quotes above a configurable threshold require approval."
period: "2026"
status: "completed"
featured: false
technologies:
