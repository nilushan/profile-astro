...
Voice fulfilment, OAuth account linking and report-state sit in the C4 model: [Diagramming a Smart-Home IoT Platform with C4](/projects/iot-platform-architecture).
...
- **Unified Logic**: Single implementation of core business logic behind platform-specific adapters
...
- Shared business logic so Alexa and Google Home behave consistently
...
- **Code reuse**: Shared business logic with platform-specific adapters for Alexa and Google Home
